var vote_function = function () {
  ...
  $.get('http://beta.pestkolera.se/app_top.php?vote=' + vote + '&tid=' + tid, function (data) {
...
$(document).ready(function () {
  $.get('http://beta.pestkolera.se/app_top.php', get_questions_factory('top'));
  $.get('http://beta.pestkolera.se/app_top.php?latest', get_questions_factory('latest'));
  ...
  $('body')
    ...
    .on('click', '.show_all', function () {
      ...
      $(this).remove();
      $.get('http://beta.pestkolera.se/app_top.php?all', get_questions_factory('latest'));
    });
});